...
def extract_vaild_path(imput_json):
    ...
    output_lc08 = '/home/jason/data_pool/sample_data/SRC_DATA_JSON/Anhui/valid_list_2017_Anhui_le07.json'
    ...
    if not os.path.exists(imput_json):
        ...
        if len(valid_list_2017_Anhui_lc08) > 0:
            ...
            print('Valid data total %s in %s' % (len(valid_list_2017_Anhui_lc08), imput_json))
        else:
...
if __name__ == '__main__':
    start = time.time()
    imput_json = '/home/jason/data_pool/sample_data/SRC_DATA_JSON/Anhui/2017-LE07-Anhui.json'
